...
function AppContent() {
  ...
  return (
    <BookLayout>
      {/* Book title */}
      <div className="border-b border-[#e8d5c0] bg-[#f9f3ea] py-3 px-4 text-center">
        <h1 className="font-display text-2xl font-semibold text-[#3d2b1f] tracking-wide">
          LoveBook
        </h1>
        <p className="text-[10px] text-[#b09080] mt-0.5 uppercase tracking-widest">
          Bizim Günlüğümüz
        </p>
      </div>
